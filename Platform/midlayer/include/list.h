...
typedef unsigned long     l32;

#define hmoffsetof(TYPE, MEMBER)   ((l32) &((TYPE *)0)->MEMBER)
 ...
 *
 */
#define container_of(ptr, type, member) (type *)((char *)ptr -hmoffsetof(type,member))
 ...
 */
static __inline void list_del_safe(struct list_head *entry, struct list_head *head)
{
...
static __inline void list_insert(struct list_head *list, struct list_head *new)
{
